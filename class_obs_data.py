...
#   if (len(dims_to_keep)==1):
#     self.val[:,dims_to_fill[0]:dims_to_fill[0]+1] = fillValue
#     self.err[:,dims_to_fill[0]:dims_to_fill[0]+1] = fillValue
#     self.pos[:,dims_to_fill[0]:dims_to_fill[0]+1] = fillValue
#     self.dep[:,dims_to_fill[0]:dims_to_fill[0]+1] = fillValue
#     self.hx[:,dims_to_fill[0]:dims_to_fill[0]+1] = fillValue
#   else:
#     self.val[:,dims_to_fill] = fillValue
#     self.err[:,dims_to_fill] = fillValue
#     self.pos[:,dims_to_fill] = fillValue
#     self.dep[:,dims_to_fill] = fillValue
#     self.hx[:,dims_to_fill] = fillValue
